	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => esc_html__("Show Twitter Icon",$themename),
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display the Twitter Icon on your homepage. ",$themename)
			),
			...
			array( "name" => esc_html__("Show RSS Icon",$themename),
                   ...
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display the RSS Icon on your homepage. ",$themename)
			),
			...
			array( "name" => esc_html__("Twitter Profile Url",$themename),
                   ...
                   "type" => "text",
                   "validation_type" => "url",
				   "desc" => esc_html__("Place the Twitter Profile URL here. ",$themename)
			),
			...
			array( "name" => esc_html__("RSS Icon Url",$themename),
                   ...
                   "type" => "text",
                   "validation_type" => "url",
				   "desc" => esc_html__("Place the RSS URL here. ",$themename)
			),
			...
			array( "name" => esc_html__("Facebook Profile Url",$themename),
                   ...
                   "type" => "text",
                   "validation_type" => "url",
				   "desc" => esc_html__("Place the Facebook Profile URL here. ",$themename)
			),
		...
		array( "name" => "general-2",
			...
			array( "name" => esc_html__("Recent Work Section Category",$themename),
				   ...
				   "desc" => esc_html__("Here you can choose the category you would like to display in the Recent Work Section on the homepage. ",$themename),
				   "options" => $site_cats),
			...
			array( "name" => esc_html__("From The Blog Section Category",$themename),
				   ...
				   "type" => "select",
				   "et_array_for" => "categories",
				   "desc" => esc_html__("Here you can choose the category you would like to display in the From The Blog Section on the homepage. ",$themename),
				   "options" => $site_cats),
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => esc_html__("Show Date Icon",$themename),
				   ...
				   "type" => "checkbox",
				   "std" => "on",
				   "desc" => esc_html__("Here you can choose to display the Date Icon ",$themename)
			),
