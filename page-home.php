...
<div id="home-sections" class="clearfix">
    ...
    <div id="recent-work">
        ...
        <a href="<?php echo esc_url( get_category_link( $recent_work_category_id ) ); ?>"
            class="readmore"><?php esc_html_e('Read More','Trim'); ?></a>
    </div> <!-- end #recent-work -->
    <?php } ?>
    ...
    <div id="from-the-blog">
        ...
        <a href="<?php echo esc_url( get_category_link( $recent_fromblog_category_id ) ); ?>"
            class="readmore"><?php esc_html_e('Read More','Trim'); ?></a>
