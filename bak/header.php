...
<body <?php body_class(); ?>>
    <div id="container">
        <div id="wrapper">
                ...
                <div id="top-area">
                    ...
                    <div id="search-form">
                        <form method="get" id="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>/">
                            <input type="text" value="<?php esc_attr_e('Search...', 'Trim'); ?>" name="s"
                                id="searchinput" />
                            <input type="image" alt="<?php echo esc_attr( 'Submit', 'Trim' ); ?>"
                                src="<?php echo esc_url( get_template_directory_uri() . '/images/search_btn.png' ); ?>"
                                id="searchsubmit" />
                        </form>
                    </div> <!-- end #search-form -->
                </div> <!-- end #top-area -->
                ...
                <div id="menu" class="clearfix">
                    ...
                    <nav id="main-menu">
                        ...
                        <ul class="<?php echo esc_attr( $menuClass ); ?>">
                            ...
                            <li <?php if (is_front_page()) echo('class="current_page_item"') ?>><a
                                    href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e('Home','Trim') ?></a>
                            </li>
                            <?php }; ?>
            ...
            <?php
				if ( 'on' == get_option('trim_featured') && is_front_page() ) get_template_part( 'includes/featured', 'home' );
